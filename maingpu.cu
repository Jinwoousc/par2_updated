...
void run(int argc, char** argv)
{
    ...
    thrust::host_vector<PAR2_FLOAT> mmb, mimb1, mimb2;
    par2::massfield::build<PAR2_FLOAT>(grid, mmb, mimb1, mimb2);
    ...
    par2::PParticles<PAR2_FLOAT> particles(grid, mmb, mimb1, mimb2, datax, datay, dataz,
